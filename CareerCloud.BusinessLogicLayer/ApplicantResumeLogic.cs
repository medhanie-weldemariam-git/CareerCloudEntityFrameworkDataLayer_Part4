...
namespace CareerCloud.BusinessLogicLayer
{
    ...
    {
        public ApplicantResumeLogic(IDataRepository<ApplicantResumePoco> dataRepository) : base(dataRepository)
        {
        ...
        protected override void Verify(ApplicantResumePoco[] pocos)
        {
            ...
            {
                if (string.IsNullOrEmpty(p.Resume))
                {
                    exceptions.Add(new ValidationException(113, $"Resume for ApplicantResume {p.Resume} cannot be empty."));
                }
            }
